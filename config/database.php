    ...
    */
    ...
    'connections' => [
        ...
        'bstore_order' => [
            ...
            'port' => env('ORDER_DB_PORT', env('DB_PORT', '3308')),
            'database' => env('ORDER_DB_DATABASE', 'bstore_order_db'),
        ...
        'bstore_payment' => [
            ...
            'port' => env('PAYMENT_DB_PORT', env('DB_PORT', '3308')),
            'database' => env('PAYMENT_DB_DATABASE', 'bstore_payment_db'),
